...
_SYSTEM = (
    ...
    "- FONTES: CONCENTRACAO_JSON e MOBILIDADE_JSON são rótulos internos do prompt — NUNCA os "
    "cite como fonte. A fonte real dos dados é 'Vísent CDRView' (dataset de telefonia móvel da "
    "Grande Florianópolis): use esse nome em 'fontes' (tipo='dataset') e em 'evidencias[].fonte'.\n"
