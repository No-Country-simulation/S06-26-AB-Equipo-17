...
- [x] Documentação do projeto e decisões técnicas (Tarefa 1)
- [x] Stack e ferramentas definidas (Tarefa 3)
- [ ] Pipeline de ingestão do Vísent funcional
- [ ] Endpoint `/dados` com resposta coerente em linguagem natural
- [ ] Mapa com ≥ 2 regiões e 1 indicador
- [ ] Interface responsiva (consulta + mapa)
- [ ] Deploy no Render
